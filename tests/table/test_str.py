        ...
        if engine_is('cockroach'):
            self.assertEqual(
                ...
                (
                    ...
                    "    id = Serial(default='unique_rowid()', null=False, primary_key=True, unique=False, index=False, index_method=IndexMethod.btree, choices=None, db_column_name='id', secret=False)\n"  # noqa: E501
